...
<ul>
    ...
    <div>
        <!--boton que te lleva de nuevo al carrito-->
        <form>
            <button type="button"><a href="/carrito"> Volver</a></button>
        </form>
      <div class="Titulosgrandes"><h1>Producto</h1></div></div>
        ...
        <div class="producto">  
            ...
            <img src="img/jaulas.jpg" width="200 px" height="200 px">
